      ...
      <SidebarProvider>
        <main className="flex !overflow-hidden w-screen h-[100dvh] bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-indigo-950/30 dark:via-purple-950/30 dark:to-pink-950/30">
          ...
          <SidebarInset className="bg-white/70 dark:bg-gray-900/70 backdrop-blur-md">
            ...
            <ThemeToggle className="fixed bottom-8 right-8 bg-white dark:bg-gray-800 shadow-lg rounded-full p-3 hover:shadow-indigo-200 dark:hover:shadow-indigo-900 cursor-pointer transition-all hover:scale-105" />
          </SidebarInset>
        </main>
      </SidebarProvider>
    </SessionWrapper>
